        ...
        if (action.equals("updateUniversity")) {
            ...
            try {
                ...
                try {
                    ...
                    if (foundedYear < 0) {
                        error += ("founded year should integer positive! <br/>");
                    }
                } catch (Exception e) {
                    error += ("founded year should integer positive! <br/>");
                }
                ...
                try {
                    ...
                    if (totalStudents < 0) {
                        error += ("total students should integer positive! <br/>");
                    }
                } catch (Exception e) {
                    error += ("total students should integer positive! <br/>");
                }
                ...
                try {
                    ...
                    if (totalFaculties < 0) {
                        error += ("total employees should integer positive! <br/>");
                    }
                } catch (Exception e) {
                    error += ("total employees should integer positive! <br/>");
                }
                ...
                if (error.isEmpty()) {
                    ...
                    if (udao.update(u)) {
                        ...
                        error += "Error, cannot update university!";
                        request.setAttribute("u", u);
                    }
